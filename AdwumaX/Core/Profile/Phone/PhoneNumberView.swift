        ...
        GeometryReader { geo in
            ...
            NavigationStack {
                VStack {
                    ...
                    Text("Your country code and phone number").textTitle()
                    ...
                    HStack {
                        ...
                        //                            }
                        BorderedTextField(text: $mobPhoneNumber, placeHolder: "Phone Number")
                    ...
                    .disableWithOpacity(mobPhoneNumber.trimmed().count != countryLimit)
